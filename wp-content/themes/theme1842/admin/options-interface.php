...
function optionsframework_fields() {
	...
	foreach ( $options as $value ) {
		...
		case 'typography':
			...
			unset( $font_size, $font_lineheight, $font_style, $font_face, $font_color );
			...
			$typography_options = array(
				...
				'lineheight' => of_recognized_font_lineheight(),
				'color' => true
			);
			...
			if ( $typography_options['lineheight'] ) {
				...
				foreach ( $lineheights as $key => $lineheight ) {
					$font_lineheight .= '<option value="' . esc_attr( $key ) . '" ' . selected( $typography_stored['lineheight'], $key, false ) . '>'. $lineheight .'</option>';
				}
			...
			$typography_fields = compact( 'font_size', 'font_lineheight', 'font_face', 'font_style', 'font_color' );
