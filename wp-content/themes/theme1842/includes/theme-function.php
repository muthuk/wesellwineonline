...
function theme1842_random($length){
...
if ( !function_exists( 'tz_gallery' ) ) {
    function tz_gallery($postid, $imagesize) { ?>
        <?php $random = theme1842_random(10); ?>
				<script type="text/javascript">
					...
					<div class="g_pagination">
						...
						<div class="g_controls">
							<a href="#"><span id="prev-gal"><?php _e('&larr;', 'theme1842'); ?></span></a> 
							<a href="#"><span id="next-gal"><?php _e('&rarr;', 'theme1842'); ?></span></a>
						</div><!--END Prev&Next -->
...
{ 
     ...
     if(1 != $pages)
     {
         ...
         if($paged > 2 && $paged > $range+1 && $showitems < $pages) echo "<a href='".get_pagenum_link(1)."'>First page</a>";
         if($paged > 1) echo "<a href='".get_pagenum_link($paged - 1)."'>Prev page</a>";
         ...
         if ($paged < $pages) echo "<a href=\"".get_pagenum_link($paged + 1)."\">next page</a>"; 
         if ($paged < $pages-1 &&  $paged+$range-1 < $pages && $showitems < $pages) echo "<a href='".get_pagenum_link($pages)."'>Last page</a>";
         echo "</div>\n";
     }
}
