...
function widget($args, $instance) {
  ...
  $cat_posts = new WP_Query($args);
    ...
    ?>
		<li class="cat_post_item-<?php echo $posts_counter; ?> clearfix">
            ...
            <?php if ( $instance['excerpt'] ) : ?>
              ...
              <?php } ?>
            <?php endif; ?>
            <?php if ( ($instance['date']) or ($instance['comment_num']) ) : ?>
	...
	<?php if ( $instance['global_link'] ) : ?>
	  <a href="<?php echo $instance['global_link_href']; ?>" class="button"><?php if($instance['global_link_text']==""){ ?>View all<?php }else{ ?><?php echo $instance['global_link_text']; ?><?php } ?></a>
	<?php endif; ?>
...
<p>
      <label for="<?php echo $this->get_field_id("custom_category"); ?>">
          <?php _e('Custom posts category slug'); ?>:
          <input class="widefat" id="<?php echo $this->get_field_id("custom_category"); ?>" name="<?php echo $this->get_field_name("custom_category"); ?>" type="text" value="<?php echo $instance["custom_category"]; ?>"/>
      </label>
</p>
